...
public class metroCard {
	...
	public static void main(String[] args) {
		 ...
		 System.out.println("extension " + metroCardF(30)); // prints out address
		
	}
	public static int[] metroCardF(int lastNumberOfDays) {
	     if(lastNumberOfDays== 31) // if 31, return an array of all different days of the month
	        return new int[]{28,30,31};
	    return new int[]{31}; // else, just return day 30
	}
