...
public class lateRide {
	...
	public static void main(String[] args) {
		...
		int hour = n / 60; // go to the hour hand
		int minute = n % 60; // go to the minue head
		List<Integer> hourMinDigits = getDigits(hour, minute);
		int sum = 0;

		for (int i : hourMinDigits) {
			sum += i;
		}
		System.out.println(sum);
	}

	public static List<Integer> getDigits(int h, int m) {
